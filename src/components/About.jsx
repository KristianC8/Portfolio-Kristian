    ...
    <section className='about'>
      <div className='about-information'>
        ...
        <div className='about-contact'>
          <a
            className='about-buttonlink about-button button-downloadcv'
            href={hv}
          ...
          <a
            className='about-buttonlink about-button button-contactme'
            href='mailto:kristian.cifuentesv@gmail.com'
            rel='noopener noreferer'
            target='_blank'
            title='Contacto'
          >
      ...
      <div className='about-aboutMe'>
        <div className='aboutme-console'>
          ...
          <div className='console-body'>
            ...
            <p>
              Cuento con tres años de experiencia como Analista de Calidad de
              Software y ahora como Desarrollador Web, lo que busco es integrar
              la funcionalidad con un diseño limpio para ofrecer una experiencia
              de usuario intuitiva, llamativa visualmente y efectiva en su
              propósito.
            </p>
          </div>
        </div>
